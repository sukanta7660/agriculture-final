    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ProjectsController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ProjectsController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
