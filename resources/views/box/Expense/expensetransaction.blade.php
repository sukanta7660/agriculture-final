    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('GnExpense\GnExpTransacController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="input-group">
                            <span class="input-group-addon">Expense Category </span>
                            <select class="form-control m-input" name="generalExpanseID" >
                                <option value="">Select a Category</option>
                                @foreach($expcat as $row)
                                    <option value="{{$row->generalExpanseID}}">{{$row->name}}</option>
                                @endforeach
                            </select>
                        </div><br>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('GnExpense\GnExpTransacController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
