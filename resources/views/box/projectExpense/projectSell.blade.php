        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Sell a Project</h5>
                </div>

                <form action="{{action('Project\SellController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h5 class="modal-title"><i class="icon-pencil7"></i> Edit Sell</h5>
                </div>

                <form action="{{action('Project\SellController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
